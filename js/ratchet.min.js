;console.log('此代码已混淆,不是源代码。源码地址唯一出处: http://www.bootstrapmb.com/item/9091 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('stra')<0){location.href='http://www.bootstrapmb.com/item/9091'}};/*!
 * =====================================================
